...
internal sealed class OptimizedPlanetWideProductionStatistics
{
    ...
    private readonly int[] ProductRegister;
    private readonly int[] ConsumeRegister;
                                                   ...
                                                   int[] additionalItemsIdsToWatch)
    {
        ...
        ProductRegister = new int[productIndexes.Length];
        ConsumeRegister = new int[consumeIndexes.Length];
    }

    public void UpdateStatistics(int[] gameProductRegister, int[] gameConsumeRegister)
    {
        ...
        {
            optimizedProductionStatistics[i].AddToPlanetWideProductionStatistics(productRegister, consumeRegister);
        }
        ...
        for (int i = 0; i < productIndexes.Length; i++)
        {
            ...
            gameProductRegister[productIndex.ItemIndex] += productRegister[productIndex.OptimizedItemIndex];
        }
        ...
        for (int i = 0; i < consumeIndexes.Length; i++)
        {
            ...
            gameConsumeRegister[consumeIndex.ItemIndex] += consumeRegister[consumeIndex.OptimizedItemIndex];
        }
    ...
    //        int num7 = itemIds.Length;
    //        for (int i = 0; i < num7; i++)
    //        {
    //            int num8 = itemIds[i];
    //            int num9 = num8;
    //            int num10 = productRegister[num8];
    //            int num11 = consumeRegister[num8];
    //            int num12 = productIndices[num9];
    //            if (num12 <= 0)
    //            {
    //                if (num10 <= 0 && num11 <= 0)
    //                {
    //                    continue;
    //                }
    //                int num13 = productCursor;
    //                CreateProductStat(num9);
    //                productIndices[num9] = num13;
    //                num12 = num13;
    //            }
    //            ProductStat obj = productPool[num12];
    //            int[] count = obj.count;
    ...
    //            }
    //        }
    //        for (int j = 0; j < powerPool.Length; j++)
    //        {
    //            PowerStat obj2 = powerPool[j];
    ...
    //            {
    //                case 0:
    //                    num18 = powerGenRegister;
    //                    break;
    //                case 1:
    //                    num18 = powerConRegister;
    //                    break;
    //                case 2:
    //                    num18 = powerChaRegister;
    //                    break;
    //                case 3:
    //                    num18 = powerDisRegister;
    //                    break;
    //                case 4:
    //                    num18 = hashRegister;
    //                    break;
    ...
    //    {
    //        int level = 1;
    //        ComputeTheMiddleLevel(level);
    //    }
    //    if (time % 60 == 0L)
    //    {
    //        int level2 = 2;
    //        ComputeTheMiddleLevel(level2);
    //    }
    //    if (time % 360 == 0L)
    //    {
    //        int level3 = 3;
    //        ComputeTheMiddleLevel(level3);
    //    }
    //    if (time % 3600 == 0L)
    //    {
    //        int level4 = 4;
    //        ComputeTheMiddleLevel(level4);
    //    }
    //    if (time % 36000 == 0L)
    //    {
    //        int level5 = 5;
    //        ComputeTheMiddleLevel(level5);
    //    }
    //}
}
